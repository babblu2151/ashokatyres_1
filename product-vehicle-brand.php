<?php
    $page_title = "Product  Vehicle Brand | Home";
    $page_seo_title = "Product  Vehicle Brand | Home";
    $db_seokywrd = "";
    $db_seodesc = "";
    $current_page = "home";
    $body_class = "homepage";
    ...
    <div class="dlab-bnr-inr style-1 overlay-black-middle" style="background-image: url(images/banner/bnr1.jpg);">
        <div class="container">
            <div class="dlab-bnr-inr-entry">
                <h1 class="text-white">Product Vehicle Brand</h1>

                <div class="d-flex justify-content-center align-items-center">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="#">Home</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Product Vehicle Brand</li>
                        </ol>
                    </nav>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-10-col-12">
                    <h3>Vehicle Brand</h3>
                    <p>You have selected <span>BMW</span></p>

                    <form action="">
                        <div class="form-group m-b20">
                            <select class="form-control">
                                <option>Choose Modal</option>
                                <option value="47" data-select2-id="391">Modal 1</option>
                                <option value="47" data-select2-id="391">Modal 2</option>
                                <option value="47" data-select2-id="391">Modal 3</option>
                                <option value="47" data-select2-id="391">Modal 4</option>
                                <option value="47" data-select2-id="391">Modal 5</option>
                                <option value="47" data-select2-id="391">Modal 6</option>
