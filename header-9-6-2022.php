    ...
    <div class="main-bar clearfix ">
        <div class="container clearfix">
            ...
            <div class="extra-cell">
                    <a href="<?php echo $rtpth ?>my-cart.php"
                        class="btn btn-primary  light phone-no shadow-none cat-home effect-1"><span><i class="fas fa-cart-arrow-down"></i>Cart</span></a>
                </div>
                <div class="extra-cell">
            ...
            <div class="header-nav navbar-collapse collapse justify-content-end" id="navbarNavDropdown">
                ...
                <ul class="nav navbar-nav navbar navbar-left">
                    <li class=""><a href="<?php echo $rtpth;?>home">Home</a></li>
                    ...
                    <li class=""><a href="<?php echo $rtpth;?>contact-us">Contact Us</a></li>
