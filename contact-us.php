...
$page_title = "Ashoka Tyres | Contact Us";
$page_seo_title = "Ashoka Tyres | Contact Us";
$db_seokywrd = "";
$db_seodesc = "";
$current_page = "contact-us";
$body_class = "contact-uspage";
include('header.php');
?>
...
<div class="page-content bg-white">
            ...
            <div class="row">
                ...
                <div class="col-xl-6 m-b40">
                    <div class="contact-area1">
                        <form class="dlab-form style-1 dlabForm" method="POST" action="script/contact.php">
                            <input type="hidden" class="form-control" name="dlabToDo" value="Contact">
                            ...
                            <div class="row sp10">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="txtemail" name="txtemail" >
                                              <span id="errorsDiv_txtemail"></span> 
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <label>Message</label>
                                        <div class="input-group">
                                            <textarea name="txtmsg" id="txtmsg" class="form-control"></textarea>
                                              <span id="errorsDiv_txtmsg"></span> 
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <div class="g-recaptcha" data-sitekey="6LefsVUUAAAAADBPsLZzsNnETChealv6PYGzv3ZN" data-callback="verifyRecaptchaCallback" data-expired-callback="expiredRecaptchaCallback">
                                            <div style="width: 304px; height: 78px;">
                                                <div><iframe title="reCAPTCHA" src="https://www.google.com/recaptcha/api2/anchor?ar=1&amp;k=6LefsVUUAAAAADBPsLZzsNnETChealv6PYGzv3ZN&amp;co=aHR0cHM6Ly9tb2JoaWwuZGV4aWdubGFiLmNvbTo0NDM.&amp;hl=en&amp;v=rPvs0Nyx3sANE-ZHUN-0nM85&amp;size=normal&amp;cb=uufyj2kfui6" role="presentation" name="a-z69twgyrg81r" scrolling="no" sandbox="allow-forms allow-popups allow-same-origin allow-scripts allow-top-navigation allow-modals allow-popups-to-escape-sandbox allow-storage-access-by-user-activation" width="304" height="78" frameborder="0"></iframe></div><textarea id="g-recaptcha-response" name="g-recaptcha-response" class="g-recaptcha-response" style="width: 250px; height: 40px; border: 1px solid rgb(193, 193, 193); margin: 10px 25px; padding: 0px; resize: none; display: none;"></textarea>
                                ...
                                <div class="col-sm-12">
                                    <button name="submit" type="submit" value="submit" class="btn btn-primary w-100 d-block btn-rounded">SEND MESSAGE </button>
                                </div>
                            </div>
                        </form>
                    </div>
    ...
    <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15226.067921892627!2d78.4887126!3d17.434953!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x77ff98db1db8b84c!2sAshoka%20Tyres!5e0!3m2!1sen!2sin!4v1639564540215!5m2!1sen!2sin" width="100%" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
