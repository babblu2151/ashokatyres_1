    							...
    							<div class="widget widget_price_range">
    								...
    								<div class="price-slide range-slider">
    									<div class="price">
    										...
    										<input type="text" id="amount" class="amount me-auto" readonly="" value="$200 - $5000" />
    					...
    					<div class="row lightgallery">
    						...
    						<div class="col-lg-4 col-md-4 col-sm-6 col-12 m-b30">
    							<div class="car-list-box list-view">
    								...
    								<div class="list-info">
    									<h6 class="title mb-0"><a href="product-display.php" data-splitting class="text-white">Goodyear 205/55 R16 Eagle NCT5 91V Tubeless Car Tyre</a></h6>
    									<div class="car-type">Sku: CE2356517ZATL</div>

    									<div class="d-flex justify-content-between align-items-center">
    										<span class="badge m-b10 mr-rt-5"><span>₹</span>8,299.00</span>
    										<a href="product-display.php" class="m-b10 view-details-btn btn btn-primary light phone-no shadow-none effect-1 w-100 text-center d-block"><span>Details</span></a>
    						...
    						<div class="col-lg-4 col-md-4 col-sm-6 col-12 m-b30">
    							<div class="car-list-box list-view">
    								<div class="media-box">
    									...
    									<div class="overlay-bx">
    										<span data-exthumbimage="images/product/grid/pic2.jpg" data-src="images/product/grid/pic1.jpg" class="view-btn lightimg">
    						...
    						<div class="col-lg-4 col-md-4 col-sm-6 col-12 m-b30">
    							<div class="car-list-box list-view">
    								<div class="media-box">
    									...
    									<div class="overlay-bx">
    										<span data-exthumbimage="images/product/grid/pic3.jpg" data-src="images/product/grid/pic1.jpg" class="view-btn lightimg">
