...
if(isset($_POST['btnbrndsbmt']) && (trim($_POST['btnbrndsbmt']) != "") && isset($_POST['lstvehtyp']) && (trim($_POST['lstvehtyp']) != "") && isset($_POST['txtname']) && (trim($_POST['txtname']) != "") && isset($_POST['txtprior']) && (trim($_POST['txtprior']) != ""))
{
  ...
  include_once "../database/iqry_veh_brnd_mst.php";
}
...
<script language="javascript" type="text/javascript">
	function funcChkDupName()
	{
		...
		if(vehtypid!="" && name != "")
		{
			var url = "chkduplicate.php?vehbrndname="+name+"&vehtypid="+vehtypid;
...
<section class="content">
	<div class="content-header">
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h1 class="m-0 text-dark">Add Vehicle Brand</h1>
				</div><!-- /.col -->
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						<li class="breadcrumb-item"><a href="#">Home</a></li>
						<li class="breadcrumb-item active">Add Vehicle Brand</li>
					</ol>
				</div><!-- /.col -->
			</div><!-- /.row -->
		</div><!-- /.container-fluid -->
			...
			<form name="frmaddvehbrnd" id="frmaddvehbrnd" method="post" action="<?php $_SERVER['PHP_SELF'];?>" enctype="multipart/form-data" onSubmit="return performCheck('frmaddvehbrnd', rules, 'inline');">
				<div class="col-md-12">
					<div class="row justify-content-center align-items-center">
							...
							<div class="row mb-2 mt-2">
								...
								<div class="col-sm-9">
									<div class="custom-file">
										<div class="custom-file">
										<input name="flebrndimg" type="file" id="flebrndimg" class="form-control">
									</div>
									</div>
								</div>
							</div>
						...
						<p class="text-center">
							<input type="Submit" class="btn btn-primary" name="btnbrndsbmt" id="btnbrndsbmt" value="Submit">
							&nbsp;&nbsp;&nbsp;
