...
/***********************************************************
Programm : add_vehicle_typ.php	
Package : 
Purpose : For add Vehicle type details
Created By : Bharath
...
{
	include_once "../database/iqry_vehtyp_mst.php";
}
...
<script language="javascript" type="text/javascript">
	function funcChkDupName()
	{
		...
		if(name != "")
		{
			var url = "chkduplicate.php?vehtypnm="+name;
			...
			<form name="frmaddvehtyp" id="frmaddvehtyp" method="post" action="<?php $_SERVER['PHP_SELF'];?>" enctype="multipart/form-data" onSubmit="return performCheck('frmaddvehtyp', rules, 'inline');">
				<div class="col-md-12">
					<div class="row justify-content-center align-items-center">
						...
						<p class="text-center">
							<input type="Submit" class="btn btn-primary" name="btnvehtypsbmt" id="btnvehtypsbmt" value="Submit">
							&nbsp;&nbsp;&nbsp;
							<input type="reset" class="btn btn-primary" name="btnvehtypreset" value="Clear" id="btnvehtypreset">
							&nbsp;&nbsp;&nbsp;
