...
Purpose : For add Tyre Brand Details
Created By : Bharath
...
if(isset($_POST['btntyrbrndsbmt']) && (trim($_POST['btntyrbrndsbmt']) != "") && isset($_POST['txtname']) && (trim($_POST['txtname']) != "") && isset($_POST['txtprior']) && (trim($_POST['txtprior']) != ""))
{
  ...
  include_once "../database/iqry_tyrebrnd_mst.php";
}
$rd_crntpgnm = "view_tyre_brnd.php";
$clspn_val = "4";
?>
...
<script language="javascript" type="text/javascript">
	function funcChkDupName()
	{
		...
		if(name != "")
		{
			var url = "chkduplicate.php?tyrbrndname="+name;
...
<section class="content">
	<div class="content-header">
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h1 class="m-0 text-dark">Add Tyre Brand</h1>
				</div><!-- /.col -->
				<div class="col-sm-6">
			...
			<form name="frmaddvehbrnd" id="frmaddvehbrnd" method="post" action="<?php $_SERVER['PHP_SELF'];?>" enctype="multipart/form-data" onSubmit="return performCheck('frmaddvehbrnd', rules, 'inline');">
				<div class="col-md-12">
					<div class="row justify-content-center align-items-center">
						...
						<p class="text-center">
							<input type="Submit" class="btn btn-primary" name="btntyrbrndsbmt" id="btntyrbrndsbmt" value="Submit">
							&nbsp;&nbsp;&nbsp;
