...
$sqrybnr_mst = "SELECT bnrm_name, bnrm_desc, bnrm_sts, bnrm_prty, bnrm_lnk, bnrm_imgnm from bnr_mst where bnrm_id = $id";
...
<script language="javascript" type="text/javascript">
	function funcChkDupName()
	{
		...
		if(name != "")
		{
			var url = "chkduplicate.php?bnrnm="+name+"&bnrid="+id;
