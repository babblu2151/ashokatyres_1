...
if(isset($_POST['btnprodfsbmt']) && (trim($_POST['btnprodfsbmt']) != "") && isset($_POST['txtname']) && (trim($_POST['txtname']) != "") && isset($_POST['txtprior']) && (trim($_POST['txtprior']) != ""))
{
  ...
  include_once "../database/iqry_prodfetr_mst.php";
}
...
<script language="javascript" type="text/javascript">
	function funcChkDupName()
	{
		...
		if(name != "")
		{
			var url = "chkduplicate.php?profetr="+name;
...
<section class="content">
	<div class="content-header">
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h1 class="m-0 text-dark">Add Product Features</h1>
				</div><!-- /.col -->
				<div class="col-sm-6">
			...
			<form name="frmaddvehbrnd" id="frmaddvehbrnd" method="post" action="<?php $_SERVER['PHP_SELF'];?>" enctype="multipart/form-data" onSubmit="return performCheck('frmaddvehbrnd', rules, 'inline');">
				<div class="col-md-12">
					<div class="row justify-content-center align-items-center">
						...
						<p class="text-center">
							<input type="Submit" class="btn btn-primary" name="btnprodfsbmt" id="btnprodfsbmt" value="Submit">
							&nbsp;&nbsp;&nbsp;
