...
/***********************************************************
Programm : add_tyre_typ.php	
Package : 
Purpose : For add Tyre type details
Created By : Bharath
...
{
	include_once "../database/iqry_tyrtyp_mst.php";
}
...
<script language="javascript" type="text/javascript">
	function funcChkDupName()
	{
		...
		if(name != "")
		{
			var url = "chkduplicate.php?tyrtypnm="+name;
	...
	function funcChkDupCde()
	{
		...
		if(code != "")
		{
			var url = "chkduplicate.php?tyrtypcde="+code;
...
<section class="content">
	<div class="content-header">
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h1 class="m-0 text-dark">Add Tyre Type</h1>
				</div><!-- /.col -->
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						<li class="breadcrumb-item"><a href="#">Home</a></li>
						<li class="breadcrumb-item active">Add Tyre Type</li>
					</ol>
				</div><!-- /.col -->
			</div><!-- /.row -->
		</div><!-- /.container-fluid -->
	...
	<div class="card">
		...
		<div class="card-body p-0">
			<form name="frmaddvehtyp" id="frmaddvehtyp" method="post" action="<?php $_SERVER['PHP_SELF'];?>" enctype="multipart/form-data" onSubmit="return performCheck('frmaddvehtyp', rules, 'inline');">
				<div class="col-md-12">
					<div class="row justify-content-center align-items-center">
						...
						<div class="col-md-12">
							<div class="row mb-2 mt-2">
								...
								<div class="col-sm-9">
									<input name="txtcde" type="text" id="txtcde" size="45" maxlength="40" onBlur="funcChkDupCde()" class="form-control">
						...
						<p class="text-center">
							<input type="Submit" class="btn btn-primary" name="btntyrtypsbmt" id="btntyrtypsbmt" value="Submit">
							&nbsp;&nbsp;&nbsp;
							<input type="reset" class="btn btn-primary" name="btntyrtypreset" value="Clear" id="btntyrtypreset">
							&nbsp;&nbsp;&nbsp;
