...
$sqrybnr_mst1 = "SELECT bnrm_id, bnrm_name, bnrm_lnk, bnrm_imgnm, bnrm_prty, bnrm_sts from bnr_mst";
if(isset($_REQUEST['txtname']) && (trim($_REQUEST['txtname'])!=""))
{
	...
	{
		$sqrybnr_mst2.=" and bnrm_name ='$txtname'";
	}
	else
	{
		$sqrybnr_mst2.=" and bnrm_name like '%$txtname%'";
	}
}
