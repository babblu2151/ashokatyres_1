...
if(isset($_POST['btnebnrsbmt']) && (trim($_POST['btnebnrsbmt']) != "") && isset($_POST['txtname']) && (trim($_POST['txtname']) != "") && isset($_POST['txtprior']) && (trim($_POST['txtprior']) != ""))
{
	...
	include_once "../database/uqry_prodfetr_mst.php";
}
...
$sqrybnr_mst = "SELECT prodfetrm_name, prodfetrm_desc, prodfetrm_sts, prodfetrm_prty, prodfetrm_lnk, prodfetrm_imgnm from prodfetr_mst where prodfetrm_id = $id";
...
<script language="javascript" type="text/javascript">
	function funcChkDupName()
	{
		...
		if(name != "")
		{
			var url = "chkduplicate.php?profetr="+name+"&bnrid="+id;
...
<section class="content">
	<div class="content-header">
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h1 class="m-0 text-dark">Edit Product Features</h1>
				</div><!-- /.col -->
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						<li class="breadcrumb-item"><a href="#">Home</a></li>
						<li class="breadcrumb-item active">Edit Product Features</li>
					</ol>
				</div><!-- /.col -->
			</div><!-- /.row -->
		</div><!-- /.container-fluid -->
	...
	<form name="frmedtbnrid" id="frmedtbnrid" method="post" action="<?php $_SERVER['PHP_SELF'];?>" onSubmit="return performCheck('frmedtbnrid', rules, 'inline');" enctype="multipart/form-data">
		...
		<input type="hidden" name="hdnbnrimg" id="hdnbnrimg" value="<?php echo $rowsbnr_mst['prodfetrm_imgnm'];?>">
		<div class="card">
			<div class="card-body">
				<div class="row justify-content-center align-items-center">
					<div class="col-md-12">
						<div class="row mb-2 mt-2">
							...
							<div class="col-sm-9">
								<input name="txtname" type="text" id="txtname" size="45" maxlength="40" onBlur="funcChkDupName()" class="form-control" value="<?php echo $rowsbnr_mst['prodfetrm_name']; ?>">
					...
					<div class="col-md-12">
						<div class="row mb-2 mt-2">
							...
							<div class="col-sm-9"> 
								<textarea name="txtdesc" cols="60" rows="3" id="txtdesc" class="form-control"><?php echo $rowsbnr_mst['prodfetrm_desc']; ?></textarea>
							</div>
						</div>
					</div>
					<div class="col-md-12">
						<div class="row mb-2 mt-2">
							...
							<div class="col-sm-9">
								...
								<?php
								$bnrimgnm = $rowsbnr_mst['prodfetrm_imgnm'];
								$bnrimgpath  = $gprodfetr_fldnm.$bnrimgnm;
					...
					<!-- <div class="col-md-12">
						<div class="row mb-2 mt-2">
							...
							<div class="col-sm-9"> 
								<input type="text" name="txtlnk" id="txtlnk" size="45" maxlength="250" class="form-control" value="<?php echo $rowsbnr_mst['prodfetrm_lnk']; ?>">
							</div>
						</div>
					</div> -->
					<div class="col-md-12">
						<div class="row mb-2 mt-2">
							...
							<div class="col-sm-9"> 
								<input type="text" name="txtprior" id="txtprior" class="form-control" size="4" maxlength="3" value="<?php echo $rowsbnr_mst['prodfetrm_prty']; ?>">
						...
						<div class="row mb-2 mt-2">
							...
							<div class="col-sm-9">
								<select name="lststs" id="lststs" class="form-control">
									<option value="a"<?php if($rowsbnr_mst['prodfetrm_sts']=='a') echo 'selected';?>>Active</option>
									<option value="i"<?php if($rowsbnr_mst['prodfetrm_sts']=='i') echo 'selected';?>>Inactive</option>
								</select>
