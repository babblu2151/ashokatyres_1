...
$sqrybnr_mst = "SELECT prodfetrm_name, prodfetrm_desc, prodfetrm_lnk, if(prodfetrm_sts = 'a', 'Active','Inactive') as prodfetrm_sts, prodfetrm_prty, prodfetrm_imgnm 
	from prodfetr_mst where prodfetrm_id = $id";
...
<section class="content">
	<div class="content-header">
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h1 class="m-0 text-dark">View Product Feature</h1>
				</div><!-- /.col -->
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						<li class="breadcrumb-item"><a href="#">Home</a></li>
						<li class="breadcrumb-item active">View product feature</li>
					</ol>
				</div><!-- /.col -->
			</div><!-- /.row -->
		</div><!-- /.container-fluid -->
				...
				<div class="row justify-content-center">
					<div class="col-md-12">
						...
						<div class="form-group row">
							...
							<div class="col-sm-8">
								<?php echo $rowsbnr_mst['prodfetrm_prty'];?>
							</div>
						</div>
						<div class="form-group row">
							<label for="txtname" class="col-sm-2 col-md-2 col-form-label">Status</label>
							<div class="col-sm-8"> 
								<?php echo $rowsbnr_mst['prodfetrm_sts'];?>
							</div>
						</div>
						<p class="text-center">
