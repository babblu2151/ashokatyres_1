...
/**********************************************************
Programm : add_tyr_prfl.php 
Purpose : For add tyre profile details
Created By : Bharath
...
{
	include_once "../database/iqry_tyrprfl_mst.php";
}
...
<script language="javascript" type="text/javascript">
	function funcChkDupName()
	{
		...
		{
			var url = "chkduplicate.php?tyrprflname="+name+"&vehtypid="+vehtypid+"&tyrwdthid="+tyrwdthid;
...
<section class="content">
	<div class="content-header">
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h1 class="m-0 text-dark">Add Tyre Profile</h1>
				</div><!-- /.col -->
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						<li class="breadcrumb-item"><a href="#">Home</a></li>
						<li class="breadcrumb-item active">Add Tyre Profile</li>
					</ol>
				</div><!-- /.col -->
			</div><!-- /.row -->
		</div><!-- /.container-fluid -->
	...
	<div class="card">
		...
		<div class="card-body p-0">
			<form name="frmaddtyrprfl" id="frmaddtyrprfl" method="post" action="<?php $_SERVER['PHP_SELF'];?>" enctype="multipart/form-data" onSubmit="return performCheck('frmaddtyrprfl', rules, 'inline');">
				<div class="col-md-12">
					<div class="row justify-content-center align-items-center">
						...
						<p class="text-center">
							<input type="Submit" class="btn btn-primary" name="btntyrprflsbmt" id="btntyrprflsbmt" value="Submit">
							&nbsp;&nbsp;&nbsp;
