...
if(isset($_POST['btnbnrsbmt']) && (trim($_POST['btnbnrsbmt']) != "") && isset($_POST['txtname']) && (trim($_POST['txtname']) != "") && isset($_POST['txtprior']) && (trim($_POST['txtprior']) != ""))
{
	...
	if($rows < 1)
	{
		...
		$iqrybnr_mst="INSERT into bnr_mst(bnrm_name, bnrm_desc, bnrm_lnk, bnrm_prty, bnrm_sts, bnrm_imgnm, bnrm_crtdon, bnrm_crtdby) values ('$name', '$desc', '$link', '$prior', '$sts', '$bnrdest', '$curdt', '$ses_admin')";
